    ...
    public static class Updater
    {
        ...
        public static UpdateStatus CheckForUpdate(Action<Version, Version, XDocument> showUpdateDialog)
        {
            try
            {
                ...
                //MessageBox.Show(string.Format("Current Version: {0} ", appVersion));
                ...
                //MessageBox.Show(string.Format("Current Version: {0}  Newest Version: {1}", appVersion, newestVersion));
            ...
            {
                Trace.WriteLine(ex);
                MessageBox.Show(string.Format("Version Check failed: {0}", ex));
            }
